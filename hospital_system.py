...
def generate_data():
    ...
    while True:
        ...
        # Heart Rate (Realistic Range: 40 - 160 BPM)
        ...
        # Temperature (Realistic Range: 34.0 - 41.0 Celsius)
        ...
        # Water Usage (Realistic Range: 0 - 50 Liters/min)
...
def start():
    """Start the hospital monitoring system."""
...
def stop():
    """Stop the hospital monitoring system."""
    if os.path.exists(PID_FILE):
